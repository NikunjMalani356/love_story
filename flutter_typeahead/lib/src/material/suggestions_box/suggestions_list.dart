// ignore_for_file: deprecated_member_use, use_late_for_private_fields_and_variables
...
class SuggestionsListState<T> extends State<SuggestionsList<T>> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (widget.minCharsForSuggestions! > 0) {
      this._suggestionsValid = true;
    } else {
  ...
  Widget build(BuildContext context) {
    final bool isEmpty = (this._suggestions?.isEmpty ?? true) && widget.controller!.text == "";
    ...
    if (widget.decoration!.constraints == null) {
      ...
      final double maxHeight = min(widget.decoration!.constraints!.maxHeight, widget.suggestionsBox!.maxHeight);
  ...
  Widget defaultSuggestionsWidget() {
    Widget child = ListView.separated(
      ...
      reverse: widget.suggestionsBox!.direction != AxisDirection.down && widget.suggestionsBox!.autoFlipListDirection,
